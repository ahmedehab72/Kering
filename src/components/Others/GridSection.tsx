    ...
    <div id='division' className="flex flex-col items-center justify-center py-6">
      ...
      Our  Divi<span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-700 to-gray-400 dark:from-gray-200 dark:to-gray-500">
          ...
          <h3 className="font-semibold text-xl py-4 ">
            Crafting Luxury Across Every Detail
          </h3>
          <p className="text-sm  text-gray-600 font-light leading-relaxed">
            At GA Group, each division embodies a unique expression of our
            passion for design events, and lifestyle. From luxury weddings and
            world-class interiors to bespoke corporate experiences and curated
            rentals, our portfolio reflects a commitment to excellence
