...
const TalentSection = () => {
  return (
    ...
    <div className="flex w-2/5 mx-auto relative items-center gap-2 ">
      <Input className="bg-white text-black h-18 " type="email" placeholder="ENTER JOB TITLE, KEYWORDS OR MISION." />
      <button className="absolute right-0 h-18 py-4 px-12 bg-[#f1e4db] hover:bg-[#f3daca] border-none rounded-none shadow-none" type="submit">
        Ok
      </button>
    </div>    </div>
  )
