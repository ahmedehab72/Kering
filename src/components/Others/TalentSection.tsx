...
const TalentSection = () => {
  return (
    ...
    <div className="flex w-[90%] lg:w-2/5 mx-auto relative items-center gap-2 ">
      ...
      <button className="absolute right-0 h-18 py-4 lg:px-12 px-4 bg-gray-300 hover:bg-gray-300/90 cursor-pointer border-none rounded-none shadow-none" type="submit">
        Ok
      </button>
    </div>    </div>
  )
